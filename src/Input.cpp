//
// Input.cpp for src in /home/brunie_j/local/my/domusic/src
//
// Made by Brunier Jean
// Login   <brunie_j@epitech.net>
//
// Started on  Sat Apr 13 22:34:51 2013 Brunier Jean
// Last update Wed May 15 14:39:30 2013 Brunier Jean
//
...
Key	Input::getKBKey()
{
  ...
  k.ptr(Key::HOR2) = &_axe[0];
  k.ptr(Key::VERT2) = &_axe[1];
  k.ptr(Key::A) = &_kb[SDLK_h];
  k.ptr(Key::X) = &_kb[SDLK_j];
  k.ptr(Key::B) = &_kb[SDLK_k];
  k.ptr(Key::Y) = &_kb[SDLK_l];
  k.ptr(Key::R1) = &_kb[SDLK_LSHIFT];
  k.ptr(Key::L1) = &_kb[SDLK_SPACE];
  return (k);
}
...
void	Input::proc()
{
  ...
  if ((SDL_GetAppState() & SDL_APPINPUTFOCUS) == 0 || _kb[SDLK_ESCAPE])
    _quitKey = true;
